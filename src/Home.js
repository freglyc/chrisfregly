  ...
  return (
    <div className="flex flex-col flex-grow items-center mx-8 my-16 md:m-36">
      <div className="w-full max-w-sm md:max-w-xl h-full flex flex-col justify-center">
        ...
        <p className="text-xl md:text-3xl font-light mb-16 md:mb-20"><span className="font-bold"><span className="wave">👋</span> I'm Chris,</span> a software engineer who dabbles in design. I'm currently traveling and working from my self converted campervan.</p>
